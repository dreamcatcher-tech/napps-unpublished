NOTE: this wiki MUST remain for archival purposes. Please see the [documentation website](https://tendermint.com/docs/) which is built from the [docs directory](https://github.com/tendermint/tendermint/tree/master/docs). Additional information about the specification can also be found in that directory.
...
* https://github.com/tendermint/tendermint/issues/1745#issuecomment-399981821
* https://github.com/tendermint/tendermint/wiki/0.7-Livelock-Scenario
