...
:::note It is recommended to read [Overview](/docs/overview) first. :::

## Transcode webm to mp4 video

:::caution If you are a [vite](https://vitejs.dev/) user, use `esm` in
**baseURL** instead of `umd`:
...
:::caution As SharedArrayBuffer is required for multithread version, make sure
you have have fulfilled
...
:::danger `progress` is an experimental feature and might not work for many
cases (ex. concat video files, convert image files, ...). Please use with
caution. :::
...
[Add WORKERFS support](https://github.com/ffmpegwasm/ffmpeg.wasm/pull/581)
...
Please check this PR:
[abort signal](https://github.com/ffmpegwasm/ffmpeg.wasm/pull/573)
